        ...
        <div class="panel-body">
            <form role="form" class="form-horizontal" method="Post" id="workorder-form">
                <div class="form-group">
                    ...
                    <div class="col-lg-3">
                        <input type="text" value="<?=dateFormat($row_workorder[0]['woTransactionDate'],'M d, Y');?>" disabled class="form-control gui-input input-sm" id="disabledInput">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-lg-6">  
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                <select name="txtNewParts" id="txtNewParts" onClick="onClickParts();">
                                    <option value="">Select Parts to add</option>
                                    <? 
                                        for($i=0;$i < count($row_partsmst);$i++){ 
                                            $val = $row_partsmst[$i]['partsID'];
                                            $desc = $row_partsmst[$i]['description'];
                                    ?>
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="txtPartsQty" id="txtPartsQty" class="text-center form-control gui-input input-md" placeholder="1" />
                            </div>
                            <div class="col-sm-2">
                        ...
                        <span id="divCost">
                                ...
                                <table class="table table-hover table-condensed table-striped table-responsive table-bordered">
                                    ...
                                    <? 
                                        ...
                                        for($i=0;$i<count($row_workorderdtl);$i++){ 
                                            $desc = $row_workorderdtl[$i]['description']; // description 
                                            $partsID = $row_workorderdtl[$i]['partsID'];
                                            ...
                                            $newArrParts .= $partsID . '::' . $row_workorderdtl[$i]['stockCode']
                                                    . '::' . $desc . '::' . $row_workorderdtl[$i]['partsPrice']
                                    ...
                                    <tr>
                                        ...
                                        <? if($status == 0 || $status == 3){ ?>
                                        <td align="center">
                                            <a href="#" onClick="removeParts('<?=$partsID;?>');">
                                                <span class="fa fa-trash"></span>
                                            </a>
                                        </td>
                                        <? } ?>
                                    </tr>
                                    <? $cnt++; } $newArrParts = rtrim($newArrParts,"|"); ?>
                                </table>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" <? if($status > 0 && $status !=3 && $status !=2){ echo $readonly; } ?> value="<?=$row_workorder[0]['labor'];?>" name="txtLabor" id="txtLabor" class="form-control gui-input input-sm" onBlur="getTotalCost();" placeholder="0.00" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3" for="txtMiscellaneous">Miscellaneous</label>
                                <div class="col-lg-4">
                                    <input type="text" <? if($status > 0 && $status !=3 && $status !=2){ echo $readonly; } ?> value="<?=$row_workorder[0]['miscellaneous'];?>" name="txtMiscellaneous" id="txtMiscellaneous" class="form-control gui-input input-sm" onBlur="getTotalCost();" placeholder="0.00" />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" <? if($status > 0 && $status !=3 && $status !=2){ echo $readonly; } ?> value="<?=$row_workorder[0]['discount'];?>" name="txtDiscount" id="txtDiscount" class="form-control gui-input input-sm" onBlur="getTotalCost();" placeholder="0.00" />
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-2">
                        <select class="required" name="txtStatus" id="txtStatus">
                            ...
                            <? if($status == 5){ ?><option value="5" <? if($status == 5){ echo 'selected'; } ?>>BILLED</option><? } ?>
